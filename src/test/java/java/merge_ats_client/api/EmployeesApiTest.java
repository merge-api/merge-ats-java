...
public class EmployeesApiTest {
    ...
    public void employeesListTest() throws ApiException {
        ...
        PaginatedEmployeeList response = api.employeesList(xAccountToken, companyId, createdAfter, createdBefore, cursor, expand, includeRemoteData, includeSensitiveFields, managerId, modifiedAfter, modifiedBefore, pageSize, remoteId, teamId, workLocationId);
    ...
    public void employeesRetrieveTest() throws ApiException {
        ...
        Boolean includeRemoteData = null;
        Boolean includeSensitiveFields = null;
        Employee response = api.employeesRetrieve(xAccountToken, id, expand, includeRemoteData, includeSensitiveFields);
