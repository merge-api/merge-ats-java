...
public class CandidatesApiTest {
    ...
    public void candidatesListTest() throws ApiException {
        ...
        PaginatedCandidateList response = api.candidatesList(xAccountToken, createdAfter, createdBefore, cursor, emailAddress, expand, firstName, includeRemoteData, lastName, modifiedAfter, modifiedBefore, pageSize, remoteId);
