...
public class JobsApiTest {
    ...
    public void jobsListTest() throws ApiException {
        ...
        String status = null;
        PaginatedJobList response = api.jobsList(xAccountToken, createdAfter, createdBefore, cursor, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status);
