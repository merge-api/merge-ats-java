...
public class InterviewsApiTest {
     ...
     */
    @Test
    public void interviewsCreateTest() throws ApiException {
        String xAccountToken = null;
        String remoteUserId = null;
        Boolean runAsync = null;
        ScheduledInterviewRequest scheduledInterviewRequest = null;
        ScheduledInterview response = api.interviewsCreate(xAccountToken, remoteUserId, runAsync, scheduledInterviewRequest);
