...
public class JobsApi {
    ...
    private okhttp3.Call jobsListValidateBeforeCall(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String status, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = jobsListCall(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status, _callback);
        return localVarCall;
    ...
    public PaginatedJobList jobsList(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String status) throws ApiException {
        ApiResponse<PaginatedJobList> localVarResp = jobsListWithHttpInfo(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status);
    ...
    public ApiResponse<PaginatedJobList> jobsListWithHttpInfo(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String status) throws ApiException {
        okhttp3.Call localVarCall = jobsListValidateBeforeCall(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status, null);
    ...
    public okhttp3.Call jobsListAsync(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteId, String status, final ApiCallback<PaginatedJobList> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = jobsListValidateBeforeCall(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status, _callback);
        Type localVarReturnType = new TypeToken<PaginatedJobList>(){}.getType();
