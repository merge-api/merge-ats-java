...
public class JobsApi {
    ...
    private okhttp3.Call jobsListValidateBeforeCall(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteFields, String remoteId, String status, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = jobsListCall(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, status, _callback);
        return localVarCall;
     ...
     */
    public PaginatedJobList jobsList(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteFields, String remoteId, String status) throws ApiException {
        ApiResponse<PaginatedJobList> localVarResp = jobsListWithHttpInfo(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, status);
    ...
    public ApiResponse<PaginatedJobList> jobsListWithHttpInfo(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteFields, String remoteId, String status) throws ApiException {
        okhttp3.Call localVarCall = jobsListValidateBeforeCall(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, status, null);
    ...
    public okhttp3.Call jobsListAsync(String xAccountToken, String code, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, Boolean includeDeletedData, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String remoteFields, String remoteId, String status, final ApiCallback<PaginatedJobList> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = jobsListValidateBeforeCall(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId, status, _callback);
        Type localVarReturnType = new TypeToken<PaginatedJobList>(){}.getType();
     ...
     */
    public okhttp3.Call jobsRetrieveCall(String xAccountToken, UUID id, Boolean includeRemoteData, String remoteFields, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call jobsRetrieveValidateBeforeCall(String xAccountToken, UUID id, Boolean includeRemoteData, String remoteFields, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = jobsRetrieveCall(xAccountToken, id, includeRemoteData, remoteFields, _callback);
        return localVarCall;
     ...
     */
    public Job jobsRetrieve(String xAccountToken, UUID id, Boolean includeRemoteData, String remoteFields) throws ApiException {
        ApiResponse<Job> localVarResp = jobsRetrieveWithHttpInfo(xAccountToken, id, includeRemoteData, remoteFields);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Job> jobsRetrieveWithHttpInfo(String xAccountToken, UUID id, Boolean includeRemoteData, String remoteFields) throws ApiException {
        okhttp3.Call localVarCall = jobsRetrieveValidateBeforeCall(xAccountToken, id, includeRemoteData, remoteFields, null);
     ...
     */
    public okhttp3.Call jobsRetrieveAsync(String xAccountToken, UUID id, Boolean includeRemoteData, String remoteFields, final ApiCallback<Job> _callback) throws ApiException {

        okhttp3.Call localVarCall = jobsRetrieveValidateBeforeCall(xAccountToken, id, includeRemoteData, remoteFields, _callback);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
