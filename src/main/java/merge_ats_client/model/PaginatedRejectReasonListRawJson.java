...
/**
 * PaginatedRejectReasonListRawJson
 */
...
public class PaginatedRejectReasonListRawJson {
  ...
  public PaginatedRejectReasonListRawJson(JSON srlzer) { 
    
    this.serializer = srlzer;
  }

  public PaginatedRejectReasonListRawJson next(String next) {
  ...
  **/
  ...
  public PaginatedRejectReasonListRawJson previous(String previous) {
  ...
  **/
  ...
  public PaginatedRejectReasonListRawJson results(List<RejectReason> results) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PaginatedRejectReasonListRawJson paginatedRejectReasonList = (PaginatedRejectReasonListRawJson) o;
    return Objects.equals(this.next.getAsString(), paginatedRejectReasonList.next.getAsString()) &&
        Objects.equals(this.previous.getAsString(), paginatedRejectReasonList.previous.getAsString()) &&
        Objects.equals(this.results.getAsString(), paginatedRejectReasonList.results.getAsString());
  }
  @Override
  public int hashCode() {
  ...
  public String toString() {
    ...
    sb.append("class PaginatedRejectReasonListRawJson {\n");
