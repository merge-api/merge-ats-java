...
/**
 * Gets or Sets SelectiveSyncConfigurationsUsageEnum
 */
@JsonAdapter(SelectiveSyncConfigurationsUsageEnum.Adapter.class)
public enum SelectiveSyncConfigurationsUsageEnum {
  ...
  */
  ...
  public static SelectiveSyncConfigurationsUsageEnum fromValue(String value) {
    for (SelectiveSyncConfigurationsUsageEnum b : SelectiveSyncConfigurationsUsageEnum.values()) {
  ...
  public static class Adapter extends TypeAdapter<SelectiveSyncConfigurationsUsageEnum> {
    @Override
    public void write(final JsonWriter jsonWriter, final SelectiveSyncConfigurationsUsageEnum enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SelectiveSyncConfigurationsUsageEnum read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SelectiveSyncConfigurationsUsageEnum.fromValue(value);
    }
  }
}
