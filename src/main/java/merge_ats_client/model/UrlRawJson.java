...
public class UrlRawJson {
  ...
  public UrlRawJson(JSON srlzer) { 
    
    this.serializer = srlzer;
  }

  public UrlRawJson value(String value) {
  ...
  **/
  ...
  public UrlRawJson urlType(UrlTypeEnum urlType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UrlRawJson url = (UrlRawJson) o;
    return Objects.equals(this.value.getAsString(), url.value.getAsString()) &&
        Objects.equals(this.urlType.getAsString(), url.urlType.getAsString());
  }
  @Override
  public int hashCode() {
