...
import java.merge_ats_client.model.EmployeePayrollRun;
import org.threeten.bp.OffsetDateTime;
import java.merge_ats_client.model.PaginatedEmployeePayrollRunList;
...
public class EmployeePayrollRunsApi {
    ...
    private okhttp3.Call employeePayrollRunsListValidateBeforeCall(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, String expand, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String payrollRunId, String remoteId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = employeePayrollRunsListCall(xAccountToken, createdAfter, createdBefore, cursor, employeeId, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, payrollRunId, remoteId, _callback);
        return localVarCall;
    ...
    public PaginatedEmployeePayrollRunList employeePayrollRunsList(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, String expand, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String payrollRunId, String remoteId) throws ApiException {
        ApiResponse<PaginatedEmployeePayrollRunList> localVarResp = employeePayrollRunsListWithHttpInfo(xAccountToken, createdAfter, createdBefore, cursor, employeeId, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, payrollRunId, remoteId);
    ...
    public ApiResponse<PaginatedEmployeePayrollRunList> employeePayrollRunsListWithHttpInfo(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, String expand, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String payrollRunId, String remoteId) throws ApiException {
        okhttp3.Call localVarCall = employeePayrollRunsListValidateBeforeCall(xAccountToken, createdAfter, createdBefore, cursor, employeeId, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, payrollRunId, remoteId, null);
    ...
    public okhttp3.Call employeePayrollRunsListAsync(String xAccountToken, OffsetDateTime createdAfter, OffsetDateTime createdBefore, String cursor, String employeeId, String expand, Boolean includeRemoteData, OffsetDateTime modifiedAfter, OffsetDateTime modifiedBefore, Integer pageSize, String payrollRunId, String remoteId, final ApiCallback<PaginatedEmployeePayrollRunList> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = employeePayrollRunsListValidateBeforeCall(xAccountToken, createdAfter, createdBefore, cursor, employeeId, expand, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, payrollRunId, remoteId, _callback);
        Type localVarReturnType = new TypeToken<PaginatedEmployeePayrollRunList>(){}.getType();
