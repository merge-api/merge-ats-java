...
import java.merge_ats_client.api.CandidatesApi;
...
# **candidatesList**
> PaginatedCandidateList candidatesList(xAccountToken, createdAfter, createdBefore, cursor, emailAddress, expand, firstName, includeRemoteData, lastName, modifiedAfter, modifiedBefore, pageSize, remoteId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PaginatedCandidateList result = apiInstance.candidatesList(xAccountToken, createdAfter, createdBefore, cursor, emailAddress, expand, firstName, includeRemoteData, lastName, modifiedAfter, modifiedBefore, pageSize, remoteId);
      System.out.println(result);
    } catch (ApiException e) {
