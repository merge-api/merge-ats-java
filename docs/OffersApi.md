...
<a name="offersList"></a>
# **offersList**
> PaginatedOfferList offersList(xAccountToken, applicationId, createdAfter, createdBefore, creatorId, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PaginatedOfferList result = apiInstance.offersList(xAccountToken, applicationId, createdAfter, createdBefore, creatorId, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteFields, remoteId);
...
# **offersRetrieve**
> Offer offersRetrieve(xAccountToken, id, includeRemoteData, remoteFields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String remoteFields = "status"; // String | Which fields should be returned in non-normalized form.
    try {
      Offer result = apiInstance.offersRetrieve(xAccountToken, id, includeRemoteData, remoteFields);
      System.out.println(result);
    } catch (ApiException e) {
