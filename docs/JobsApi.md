...
<a name="jobsList"></a>
# **jobsList**
> PaginatedJobList jobsList(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PaginatedJobList result = apiInstance.jobsList(xAccountToken, code, createdAfter, createdBefore, cursor, includeDeletedData, includeRemoteData, modifiedAfter, modifiedBefore, pageSize, remoteId, status);
...
# **jobsRetrieve**
> Job jobsRetrieve(xAccountToken, id, includeRemoteData)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean includeRemoteData = true; // Boolean | Whether to include the original data Merge fetched from the third-party to produce these models.
    try {
      Job result = apiInstance.jobsRetrieve(xAccountToken, id, includeRemoteData);
      System.out.println(result);
    } catch (ApiException e) {
